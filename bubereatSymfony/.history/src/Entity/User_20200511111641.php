...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Restaurants", mappedBy="favoritRestaurants")
     */
    ...
    public function addFavoritRestaurant(Restaurants $favoritRestaurant): self
    {
        if (!$this->favoritRestaurants->contains($favoritRestaurant)) {
            ...
            $favoritRestaurant->setFavoritRestaurants($this);
        }
    ...
    public function removeFavoritRestaurant(Restaurants $favoritRestaurant): self
    {
        if ($this->favoritRestaurants->contains($favoritRestaurant)) {
            ...
            // set the owning side to null (unless already changed)
            if ($favoritRestaurant->getFavoritRestaurants() === $this) {
                $favoritRestaurant->setFavoritRestaurants(null);
            }
        }
