...
/**
 * @ApiResource(
 * normalizationContext={"groups"={"user_informations"}, "enable_max_depth"=true}
 * )
...
class User implements UserInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Restaurants", inversedBy="user")
     * @Groups("user_informations")
     */
    private $favoritRestaurants;

    /**
     * @ORM\OneToOne(targetEntity="App\Entity\Restaurants", mappedBy="user")
     */
    private $restaurants;
    ...
    public function setRestaurants(?Restaurants $restaurants): self
    {
        ...
        $newUser = null === $restaurants ? null : $this;
        if ($restaurants->getUser() !== $newUser) {
            $restaurants->setUser($newUser);
        }
