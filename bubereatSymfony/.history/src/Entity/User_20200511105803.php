...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Restaurants", mappedBy="favorite")
     */
    private $favoris;
    ...
    public function getFavoriteRestaurants(): ?array
    {
        return $this->favoriteRestaurants;
    }

    public function setFavoriteRestaurants(?array $favoriteRestaurants): self
    {
    ...
    public function addFavori(restaurants $favori): self
    {
        if (!$this->favoris->contains($favori)) {
            $this->favoris[] = $favori;
            $favori->setFavorite($this);
        }

        return $this;
    }

    public function removeFavori(restaurants $favori): self
    {
        if ($this->favoris->contains($favori)) {
            $this->favoris->removeElement($favori);
            // set the owning side to null (unless already changed)
            if ($favori->getFavorite() === $this) {
                $favori->setFavorite(null);
            }
        }
