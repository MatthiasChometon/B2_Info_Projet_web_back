    ...
    public function load(ObjectManager $manager)
    {
        ...
        for ($i = 0; $i < 300; $i++) {
            ...
            $commande->setState($faker->numberBetween(State::IN_PROGRESS, State::DELIVERED))
                ...
                ->setDeliveryDate($faker->dateTimeThisYear($max = 'now', $timezone = 'Europe/Paris'))
                ->setDeliveryNumber($faker->numberBetween($min = 10000, $max = 100000));
        ...
        for ($i = 0; $i < 60; $i++) {
            ...
            $user->setEmail($faker->email())
                ...
                ->setBalance($faker->numberBetween($min = 10, $max = 500));
